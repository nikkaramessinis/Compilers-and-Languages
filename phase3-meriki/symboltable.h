...
typedef struct expr{
	...
	backpatch *falselist;
	struct expr *next;
	unsigned char notflag;
	unsigned char andorflag;
	unsigned char relopflag;
}expr;
...
typedef struct assistquad{
 ...
 unsigned label;
 unsigned line;
 struct assistquad *next;
}assistquad;

assistquad *assistquads;
